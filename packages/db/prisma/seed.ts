...
public class Main {
    ...
    testCases: {
      create: [
        ...
        { order: 3, input: '4\n1 5 3 7\n8', expectedOutput: '1 3', isSample: false },
...
public class Main {
    ...
    testCases: {
      create: [
        ...
        { order: 5, input: 'nooneatscats', expectedOutput: 'stactsaenoone', isSample: false },
      ],
    },
  },
  {
...
public class Main {
    ...
    testCases: {
      create: [
        ...
        { order: 4, input: '2 3\nABC\nDEF\nABF', expectedOutput: 'true', isSample: false },
        { order: 5, input: '3 3\nAAA\nAAA\nAAA\nAAAAAAAAA', expectedOutput: 'false', isSample: false },
      ],
    },
  },
  {
...
public class Main {
    ...
    testCases: {
      create: [
        ...
        { order: 3, input: '3\nabc\ndef\nghi', expectedOutput: 'abcdefghi', isSample: false },
        { order: 4, input: '4\nba\nbc\nac\nca', expectedOutput: 'bca', isSample: false },
        { order: 5, input: '5\nzyx\nwvu\nuts\nrqo\npon', expectedOutput: 'zyxwvutsrqopon', isSample: false },
      ],
    },
  },
  {
